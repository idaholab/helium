...
extern "C" int PT_FLASH_DERIV_HE(double p,
                                ...
                                double & dudt_p,
                                double & dpdt_u);
extern "C" int PH_FLASH_HE(double p,
                           double h,
                           double & v,
                           double & vt,
                           double & u);
...
{
  double v, vt, e;
  PH_FLASH_HE(p * _to_MPa, h * _to_kJ, v, vt, e);
    ...
    Real p, Real T, Real & rho, Real & drho_dp, Real & drho_dT) const
{
  ...
  const unsigned int ierr = PT_FLASH_DERIV_HE(
...
void
HeliumFluidProperties::rho_from_p_s(Real p,
                                       Real s,
                                       Real & rho,
                                       Real & drho_dp,
                                       Real & drho_ds) const
