...
//
SBTLAPI void __stdcall HS_FLASH_DERIV_HE(double v, double vt, double u, double& dvdh_s, double& dvds_h, double& dhds_v, double& dudh_s, double& duds_h, double& dhds_u) throw()
{
...
//
SBTLAPI void __stdcall HS_PT_FLASH_DERIV_HE(double v, double vt, double u, double& p, double& dpdh_s, double& dpds_h, double& dhds_p, double& t, double& dtdh_s, double& dtds_h, double& dhds_t) throw()
{
    double dhdv_u, dhdu_v;
    double dpdv_u, dpdu_v, dudv_p;
